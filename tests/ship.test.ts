...
describe('Ship', () => {
    ...
    it.each([
        // Directions
        [new Velocity(100, 0), Direction.Right, null, 1, new Velocity(1000, 0)],
        [new Velocity(100, 0), Direction.Right, null, 0.1, new Velocity(300, 0)],
        [new Velocity(0, 0), Direction.Right | Direction.Down, null, 0.1, new Velocity(141.4214, 141.4214)],

        // Desired position
        [new Velocity(100, 0), Direction.None, new Coordinates(1000, 100), 1, new Velocity(1000, 0)],
        [new Velocity(100, 0), Direction.None, new Coordinates(1000, 100), 0.1, new Velocity(300, 0)],
        [new Velocity(0, 0), Direction.None, new Coordinates(1000, 1000), 0.1, new Velocity(141.4214, 141.4214)],

        // Combined
        [new Velocity(100, 0), Direction.Right, new Coordinates(1000, 100), 0.1, new Velocity(300, 0)],
        [new Velocity(0, 0), Direction.Left, new Coordinates(100, 1000), 0.1, new Velocity(-141.4214, 141.4214)],

        // Velocity limit
        [new Velocity(1000, 0), Direction.Right, null, 1, new Velocity(1000, 0)],
        [new Velocity(500, 0), Direction.Right, null, 1, new Velocity(1000, 0)],

        // Decelerating
        [new Velocity(1000, 0), Direction.None, null, 1, new Velocity(0, 0)],
        [new Velocity(1000, 0), Direction.None, null, 0.2, new Velocity(600, 0)],
        [new Velocity(-150, -200), Direction.None, null, 0.1, new Velocity(-30, -40)],

        // Stopped
        [new Velocity(0, 0), Direction.None, null, 1, new Velocity(0, 0)],
    ])('processInput() startingVelocity: %p, direction: %p, desiredPosition: %p, duration: %p, expectedVelocity: %p', 
            (startingVelocity: Velocity, direction: Direction, desiredPosition: Coordinates | null, duration: number, expectedVelocity: Velocity) => {
        let subject = new Ship(new Coordinates(100, 100));
